  ...
  if($msg_type == 'pm') {
    if($chat_username == $u_username) {
      if($chat_csplitt == 'on') {
        ...
        $tochat_usernamer = "to $chat_usernamer <img src=\"$chat_stickerr\" alt=\"\" style=\"height: 16px;\"> $verif_checkkkkk";
      }
      if($chat_stickerr != '') {
        $whisper_stickerr = "<img src=\"$chat_stickerr\" alt=\"\" style=\"height: 16px;\">";
      }
      ...
      echo "  <div style=\"display:block\">
              <table style=\"float: right; width: 100%; text-align: right;\"><tr><td onclick=\"csplBox();expand('csplit_hidden');\" style=\"color: $username_color; font-family: 'Dosis', sans-serif; font-weight: bold;\">";
              if($chat_csplit == 'on') {
...
/*   vvv   IF THE CHAT MESSAGE IS NORMAL    vvvv   */
    ...
    if($chat_username == $u_username) {
      ...
      if($mtype == 'img') {
        ...
        // Data Saver
        if($u_datasaver == 'on') {
          echo "<div onclick=\"expand('$chat_id')\" style=\"box-shadow: 0 14px 28px rgba(0,0,0,0.25), 0 10px 10px rgba(0,0,0,0.22);word-wrap: break-word; border-radius: 20px; font-family: 'Dosis', sans-serif; display: inline-block; float: right; max-width: 60%; -webkit-box-sizing: border-box; -moz-box-sizing: border-box; box-sizing: border-box;\">[view image]</div>";
        }
        else {
          echo "<div onclick=\"expand('$chat_id')\" style=\"box-shadow: 0 14px 28px rgba(0,0,0,0.25), 0 10px 10px rgba(0,0,0,0.22);word-wrap: break-word; border-radius: 20px; font-family: 'Dosis', sans-serif; display: inline-block; float: right; max-width: 60%; -webkit-box-sizing: border-box; -moz-box-sizing: border-box; box-sizing: border-box;\"><img src=\"$c_imgurl\" alt=\"\" width=\"100%\" style=\"display: block; height: auto;\"></div>";
        }
        // Data Saver
        //
      }
      ...
      if($mtype == 'img') {
        ...
        // Data Saver
        if($u_datasaver == 'on') {
          echo "<div onclick=\"expand('$chat_id')\" style=\"box-shadow: 0 14px 28px rgba(0,0,0,0.25), 0 10px 10px rgba(0,0,0,0.22);word-wrap: break-word; border-radius: 20px; font-family: 'Dosis', sans-serif; display: inline-block; float: left; max-width: 60%; -webkit-box-sizing: border-box; -moz-box-sizing: border-box; box-sizing: border-box;\">[view image]</div>";
        }
        else {
          echo "<div onclick=\"expand('$chat_id')\" style=\"box-shadow: 0 14px 28px rgba(0,0,0,0.25), 0 10px 10px rgba(0,0,0,0.22);word-wrap: break-word; border-radius: 20px; font-family: 'Dosis', sans-serif; display: inline-block; float: left; max-width: 60%; -webkit-box-sizing: border-box; -moz-box-sizing: border-box; box-sizing: border-box;\"><img src=\"$c_imgurl\" alt=\"\" width=\"100%\" style=\"display: block; height: auto;\"></div>";
        }
        // Data Saver
        //
      }
