...
if($mens <= 1) {
echo "<i class=\"fa fa-circle\" aria-hidden=\"true\" id=\"color_go\"></i> <span class=\"darkmd\" style=\"font-weight: bold;\">$l_cnt</span> <span class=\"darkmd\">online.</span><br>";
}
elseif($mens <= 2) {
  echo "<i class=\"fa fa-circle\" aria-hidden=\"true\" id=\"color_slow\"></i> <span class=\"darkmd\" style=\"font-weight: bold;\">$l_cnt</span> <span class=\"darkmd\">online.</span><br>";
}
elseif($mens < 5) {
  echo "<i class=\"fa fa-circle\" aria-hidden=\"true\" id=\"color_slow\"></i> <span class=\"darkmd\" style=\"font-weight: bold;\">$l_cnt</span> <span class=\"darkmd\">online.</span><br>";
}
else {
  echo "<i class=\"fa fa-circle\" aria-hidden=\"true\" id=\"color_dead\"></i> <span class=\"darkmd\" style=\"font-weight: bold;\">$l_cnt</span> <span class=\"darkmd\">online.</span><br>";
}
?>
<span class="online_list">
  ...
  if ($mins <= 1) {
    ...
    if($online_verf == 'yes') {
      echo "<i style=\"color: #6d667f;\" class=\"fa fa-check-circle\" aria-hidden=\"true\"></i> ";
    }
    ...
    echo "<br>";
    echo "<div style=\"width: 100%; background-color: #aea3cc;\">
...
<b>Punch</b> <br>
<b style=\"color: #6d667f;\">/p USER</b> [-1 HP; COST: -15 MDF] <br>
<b>Stab</b> <br>
<b style=\"color: #6d667f;\">/st USER</b> [-5 HP; COST: -30 MDF] <br>
<b>Shoot</b> <br>
<b style=\"color: #6d667f;\">/s USER</b> [-10 HP; COST: -50 MDF] <br>
<b>Nuke</b> <br>
<b style=\"color: #6d667f;\">/nuke USER</b> [-100 HP; COST: -10,000 MDF] <br>
<b>Break Shield</b> <br>
<b style=\"color: #6d667f;\">/bs USER</b> [COST: -1,000 MDF] <br><br>
<b>Use Shield</b> <br>
<b style=\"color: #6d667f;\">/shd</b> [DURATION: 60s; COST: -300 MDF] <br>
<b>Use Shield+</b> <br>
<b style=\"color: #6d667f;\">/shp</b> [DURATION: 2min; COST: -700 MDF] <br>
<b>Use Shield++</b> <br>
<b style=\"color: #6d667f;\">/shpp</b> [DURATION: 5min; COST: -1,200 MDF] <br>
</center>";
?> <br>
