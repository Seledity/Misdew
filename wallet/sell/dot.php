  ...
  <body>
    <center>
        ...
        <table style="width: 100%; padding: 8px;">
          ...
          <tr>
            <td style="width: 100%; color: #e6007a; font-weight: bold;">
              <span style="font-size: 12px; font-weight: normal;">how much $DOT do you want to sell?</span> <br>
              <span style="font-size: 12px; font-weight: normal;">press enter to ensure calculations</span> <br>
              <input id="sell_input" max="<?php echo $u_funds; ?>" onkeypress="amntSellVal()" onkeyup="amntSellVal()" class="sell_input" type="number" placeholder="enter $DOT amount...">
            </td>
          </tr>
          <tr>
            <td style="width: 100%; color: #808080; font-weight: bold; font-size: 16px;">
              $DOT to Sell: <span id="mdf_sell_amnt" style="font-weight: normal;">0</span> <br>
      ...
      <button onclick="beginSale();" type="button" class="wallet_btns" style="border: none; border-top-left-radius: 0px;border-top-right-radius: 0px; background-color: #e6007a; color: #fff; width: 95% !important; max-width: 450px !important; ">
        <i class="fa fa-minus-circle"></i> tap to sell $DOT
      </button> <br>
    ...
    function beginSale() {
      ...
      var msg = "Are you sure that you want to sell " + sell_amount + " $DOT?";
      if(confirm(msg)) {
    ...
    function amntSellVal(a) {
      ...
      $.get("dot-selvue.php?a=" + sell_amount, function(d) {
        $("#mdf_sell_val").html(d);
      });
    }
    function walMDF() {
