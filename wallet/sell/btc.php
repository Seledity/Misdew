  ...
  <body>
    <center>
        ...
        <table style="width: 100%; padding: 8px;">
          ...
          <tr>
            <td style="width: 100%; color: #F7931A; font-weight: bold; font-size: 18px;">
              Sell your $BTC for $TRU. <br>
              You can use $TRU to buy other currencies.
            </td>
          </tr>
          <tr>
            <td style="width: 100%; color: #808080; font-weight: bold; font-size: 16px;">
              Price: <span id="btc_liveprice" style="font-weight: normal;">loading...</span> <br>
              Wallet: <span id="btc_wallet" style="font-weight: normal;">loading...</span> <br>
              $TRU Value: <span id="btc_liveval" style="font-weight: normal;">loading...</span> <br>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            <td style="width: 100%; color: #F7931A; font-weight: bold;">
              <span style="font-size: 12px; font-weight: normal;">how much $BTC do you want to sell?</span> <br>
              <span style="font-size: 12px; font-weight: normal;">press enter to ensure calculations</span> <br>
              <input id="sell_input" max="<?php echo $u_funds; ?>" onkeypress="amntSellVal()" onkeyup="amntSellVal()" class="sell_input" type="number" placeholder="enter $BTC amount...">
            </td>
          </tr>
          <tr>
            <td style="width: 100%; color: #808080; font-weight: bold; font-size: 16px;">
              $BTC to Sell: <span id="mdf_sell_amnt" style="font-weight: normal;">0</span> <br>
      ...
      <button onclick="beginSale();" type="button" class="wallet_btns" style="border: none; border-top-left-radius: 0px;border-top-right-radius: 0px; background-color: #F7931A; color: #fff; width: 95% !important; max-width: 450px !important; ">
        <i class="fa fa-minus-circle"></i> tap to sell $BTC
      </button> <br>
    ...
    function beginSale() {
      ...
      var msg = "Are you sure that you want to sell " + sell_amount + " $BTC?";
      if(confirm(msg)) {
    ...
    function amntSellVal(a) {
      ...
      $.get("btc-selvue.php?a=" + sell_amount, function(d) {
        $("#mdf_sell_val").html(d);
      });
    }
    function walMDF() {
