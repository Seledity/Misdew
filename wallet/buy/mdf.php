  ...
  <body>
    <center>
        ...
        <table style="width: 100%; padding: 8px;">
          ...
          <tr>
            <td style="width: 100%; color: #808080; font-weight: bold; font-size: 16px;">
              Price per $MDF: <span id="mdf_liveprice" style="font-weight: normal;">loading...</span> <br>
              $MDF Wallet: <span id="mdf_wallet" style="font-weight: normal;">loading...</span> <br>
          ...
          <tr>
            <td style="width: 100%; color: #808080; font-weight: bold; font-size: 16px;">
              ...
              $MDF Received: <span id="mdf_sell_val" style="font-weight: normal;">0.00</span> <span style="font-weight: normal;font-size: 12px;">[estimated]</span> <br>
      ...
      <button onclick="beginSale();" type="button" class="wallet_btns" style="border: none; border-top-left-radius: 0px;border-top-right-radius: 0px; background-color: #a64ca6; color: #fff; width: 95% !important; max-width: 450px !important; ">
        <i class="fa fa-plus-circle"></i> tap to buy $MDF
      </button> <br>
    ...
    function beginSale() {
      ...
      var msg = "Are you sure that you want to spend " + sell_amount + " $TRU to buy $MDF?";
      if(confirm(msg)) {
    ...
    function amntSellVal(a) {
      ...
      $.get("mdf-byvue.php?a=" + sell_amount, function(d) {
        $("#mdf_sell_val").html(d);
      });
    }
    function walMDF() {
