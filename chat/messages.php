...
echo "<center><span style=\"color: #808080; font-size: 12px; font-family: 'Dosis', sans-serif;\">Current rate per message: <b>+$chat_msg_per_rate</b> MDF - don't spam</span></center>";
...
/*   vvv   IF THE CHAT MESSAGE IS NORMAL    vvvv   */
    ...
    if($chat_username == $u_username) {
      ...
      if($mtype == 'img') {
        ...
        // Data Saver
        if($u_datasaver == 'on') {
          echo "<div onclick=\"expand('$chat_id')\" style=\"box-shadow: 0 1px 20px rgba(0,0,0,0.19), 0 3px 3px rgba(0,0,0,0.23); word-wrap: break-word; border-radius: 20px; font-family: 'Dosis', sans-serif; display: inline-block; float: right; max-width: 60%; -webkit-box-sizing: border-box; -moz-box-sizing: border-box; box-sizing: border-box;\">[view image]</div>";
        }
        else {
          echo "<div onclick=\"expand('$chat_id')\" style=\"box-shadow: 0 1px 20px rgba(0,0,0,0.19), 0 3px 3px rgba(0,0,0,0.23); word-wrap: break-word; border-radius: 20px; font-family: 'Dosis', sans-serif; display: inline-block; float: right; max-width: 60%; -webkit-box-sizing: border-box; -moz-box-sizing: border-box; box-sizing: border-box;\"><img src=\"$c_imgurl\" alt=\"\" width=\"100%\" style=\"display: block; height: auto;\"></div>";
        }
        // Data Saver
        //
      }
      ...
      if($mtype == 'img') {
        ...
        // Data Saver
        if($u_datasaver == 'on') {
          echo "<div onclick=\"expand('$chat_id')\" style=\"box-shadow: 0 1px 20px rgba(0,0,0,0.19), 0 3px 3px rgba(0,0,0,0.23); word-wrap: break-word; border-radius: 20px; font-family: 'Dosis', sans-serif; display: inline-block; float: left; max-width: 60%; -webkit-box-sizing: border-box; -moz-box-sizing: border-box; box-sizing: border-box;\">[view image]</div>";
        }
        else {
          echo "<div onclick=\"expand('$chat_id')\" style=\"box-shadow: 0 1px 20px rgba(0,0,0,0.19), 0 3px 3px rgba(0,0,0,0.23); word-wrap: break-word; border-radius: 20px; font-family: 'Dosis', sans-serif; display: inline-block; float: left; max-width: 60%; -webkit-box-sizing: border-box; -moz-box-sizing: border-box; box-sizing: border-box;\"><img src=\"$c_imgurl\" alt=\"\" width=\"100%\" style=\"display: block; height: auto;\"></div>";
        }
        // Data Saver
        //
      }
