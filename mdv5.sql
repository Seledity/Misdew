...
--
-- Host: localhost:3306
-- Generation Time: Jul 20, 2022 at 12:47 PM
...
--
-- Table structure for table `dsiplaza`
--

CREATE TABLE `dsiplaza` (
  `id` int(11) NOT NULL,
  `uagent` text NOT NULL,
  `tstamp` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `enc_chat`
--

CREATE TABLE `enc_chat` (
  `id` int(11) NOT NULL,
  `uid` text NOT NULL,
  ...
  `display_name` char(55) NOT NULL DEFAULT 'yes',
  `mtype` text NOT NULL,
...
--
-- Table structure for table `enc_data`
--
...
CREATE TABLE `enc_data` (
  ...
  `enc_data` longtext NOT NULL,
  `tstamp` text NOT NULL,
  `uid_owner` text NOT NULL,
  `uid_receive` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `mdds`
--
...
--
-- Indexes for table `dsiplaza`
--
ALTER TABLE `dsiplaza`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `enc_chat`
--
ALTER TABLE `enc_chat`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `enc_data`
--
ALTER TABLE `enc_data`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `dsiplaza`
--
ALTER TABLE `dsiplaza`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `enc_chat`
--
ALTER TABLE `enc_chat`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1433;
--
-- AUTO_INCREMENT for table `enc_data`
--
ALTER TABLE `enc_data`
...
--
ALTER TABLE `mdds`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52083;
--
